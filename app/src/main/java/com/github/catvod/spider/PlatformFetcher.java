...
public class PlatformFetcher {
    ...
    // ─── Tencent cache ──────────────────────────────────────────────────────
    private static final int TENCENT_CACHE_MAX = 100;
    private static final LinkedHashMap<String, JSONArray> tencentCache = new LinkedHashMap<String, JSONArray>() {
        @Override
        protected boolean removeEldestEntry(Map.Entry<String, JSONArray> eldest) {
            return size() > TENCENT_CACHE_MAX;
        }
    };
